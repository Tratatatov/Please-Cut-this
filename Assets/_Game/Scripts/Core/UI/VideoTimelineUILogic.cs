...
public class VideoTimelineUILogic : IInitializable, IUpdatable, IDisposableService
{
    ...
    private readonly VideoPlayerManager _playerManager;
    private readonly VideoCutManager _cutManager;
    ...
    public VideoTimelineUILogic(VideoTimelineUIView view, VideoPlayerManager playerManager, VideoCutManager cutManager)
    {
        _view = view;
